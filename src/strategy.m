...
%从2009年1月5日开始的价格序列;
ma_10 = getMovingAverage(data(:, 4), 10);
ma_20 = getMovingAverage(data(:, 4), 20);
ma_60 = getMovingAverage(data(:, 4), 60);
data = [data ma_10 ma_20 ma_60];
...
port_parity(:, 6) = ones(days_since_2009_01_05, 1);
...
signal = zeros(days_since_2009_01_05, 1);
...
stock_weight(1) = (1/stock_vol(1)) / (1/stock_vol(1) + 1/bond_vol(1));
...
%计算风险平价策略净值;
[coe, stock_weight, bond_weight, stock_w, bond_w, port_parity, signal] = calculateStrategy(20, 1, coe, stock_weight, bond_weight, stock_w, bond_w, port_parity, days_since_2009_01_05, price, signal, extra_weight);
...
for k = 1:floor(days_since_2009_01_05/20)
    ...
    %计算风险平价策略净值;
    [coe, stock_weight, bond_weight, stock_w, bond_w, port_parity, signal] = calculateStrategy(20, start_date, coe, stock_weight, bond_weight, stock_w, bond_w, port_parity, days_since_2009_01_05, price, signal, extra_weight);
end
